...
import expression.expressionInterfaces.ToMiniString;
...
public class ExpressionTester<E extends ToMiniString, C> extends Tester {
    ...
    public ExpressionTester<E, C> basic(final String full, final String mini, final E expected, final E actual) {
    ...
    public ExpressionTester<E, C> advanced(final String full, final String mini, final E expected, final E actual) {
